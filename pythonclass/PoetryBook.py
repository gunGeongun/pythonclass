#시 출력 프로그램 (시집 객체를 위한 클래스 PoetryBook.py) 1926005 2학년 김건 
from Poetry import *
title = '산유화'
poet='김소월'
contents = '''
...
class PoetryBook:
    def __init__(self,PoetryBook):
        self.PoetryBook = PoetryBook
    def getTitles(self):
        menuContents = [Poetry.getTitle() for Poetry in self.PoetryBook]
        return menuContents
    def getPoetry(self,menuNumber):
        myPoetryBooks = self.PoetryBook[int(menuNumber)-1]
        return myPoetryBooks
